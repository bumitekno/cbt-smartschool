  ...
  <body onload="myFunction()" style="margin:0;">
    ...
    <body class="font-medium" style="background-color:#cacaca">
      ...
      <div style="display:none;" id="myDiv" class="animate-bottom">
        ...
        <br>
        <a id='ok' href='index.php'><button id='ok' type='button' class='btn btn-primary btn-xs'><i
              class='fa fa-home'></i> BERANDA</button></a>
        <a id='ok' href='logout.php'><button id='ok' type='button' class='btn btn-primary btn-xs'><i
