...
$query = mysqli_query($konek, "SELECT * FROM soal WHERE kodesoal='$kodesoal' AND status='2' ORDER by nomersoal ASC");
...
while($or = mysqli_fetch_array($query)){
	...
	$query2 = mysqli_query($konek, "SELECT * FROM jawaburaian WHERE nis='$nis' AND kodesoal='$kodesoal' AND nomersoal='$nosol' ORDER by nomersoal ASC");
	if($query2 == false){
		die ("Terjadi Kesalahan : ". mysqli_error($konek));
	}
...
?>
	...
	<div class="col-xs-12">
		...
		<div class="attachment">
			<a href="#" class="name">
				<br>
				Soal nomer <?php echo $or['nomersoal']; ?>
			</a>
			<p class="filename">
				<?php echo $or['soal']; ?>
