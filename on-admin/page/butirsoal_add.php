...
$soal 	= $_POST['soal'];
$pilihan1 = $_POST['pilihan1'] ?? null;
$pilihan2 = $_POST['pilihan2'] ?? null;
$pilihan3 = $_POST['pilihan3'] ?? null;
$pilihan4 = $_POST['pilihan4'] ?? null;
...
if (
	$add = mysqli_query($konek, "INSERT INTO soal (jenissoal, kodemapel, kodesoal, nomersoal, soal, pilihan1, pilihan2, pilihan3, pilihan4, pilihan5, kunci, gambarsoal, gambar_a, gambar_b, gambar_c, gambar_d, gambar_e, audio, status) VALUES 
