...
if (empty($lokasi_file)) {
	if ($edit = mysqli_query($konek, "UPDATE siswa SET nis='$nis', nama='$nama', agama='$agama', kelas='$kelas$rombel', jurusan='$jurusan', pass='$pass', sesi='$sesi', ruang='$ruang' WHERE id='$id'")) {
