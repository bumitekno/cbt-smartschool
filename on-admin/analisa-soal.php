      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <a href="hasiltest.php"><button type="button" class="btn btn-warning" data-toggle=""><i
                    class="fa fa-angle-left"></i> Kembali</button></a>
              <button class="btn btn-default" float:right onclick="printDiv('printableArea')"><i
