...
--
-- Host: localhost:3306
-- Generation Time: Sep 01, 2023 at 07:19 AM
...
(67, '0012345Pogdas-UTS', 'Dian', '10IPA', 'Pemrograman Dasar', 2, 'Pogdas-UTS', '1', 'XX', '11:25:29am', '31-08-2023', '0', '', 'BC', 0),
...
(1, 'Sekolah Demo Smartschool', 'Jl. Raya Krangan - Pringsurat, Kenteng, Kebumen,', 'sekolah', 'mysch.png', 'myschid.png', 'Ujian Akhir Semester', 'Temanggung', '26 Juni 2020', '2023/2024', 'sma.png', 'https://mysch.web.id/', 'Tanda_Tangan.png', 'Dadang S. Pd', '19755551997031005');
...
CREATE TABLE `soal` (
  `id` int NOT NULL,
  `jenissoal` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `kodemapel` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `kunci` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(96, 'PTS', 'Pemrograman Dasar', 'Pogdas-UTS', 2, 'Sebuah prosedur langkah demi langkah yang pasti untuk menyelesaikan sebuah masalah di sebut :', '', 'Proses&nbsp;', 'Program&nbsp;', 'Algoritma&nbsp;', 'Diagram&nbsp;', 'Step&nbsp;', '', '', '', '', '', 'C', '', 1),
(95, 'PTS', 'Pemrograman Dasar', 'Pogdas-UTS', 1, 'Dalam menyusun suatu program,langkah pertama yang harus di lakkukan adalah', '', 'Membuat program&nbsp;', 'Membuat algoritma&nbsp;', 'Membeli komputer&nbsp;', 'Merakit komputer&nbsp;', 'Mengelola algoritma&nbsp;', '', '', '', '', '', 'B', '', 1),
(97, 'PTS', 'PJOK', 'TKJ-PJOK', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, 1);
...
CREATE TABLE `ujian` (
  `Urut` int NOT NULL,
  `jenis` varchar(50) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `mapel` varchar(50) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `kodesoal` varchar(50) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `waktu` varchar(8) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `lamaujian` varchar(12) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `kunci` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `aktif` int NOT NULL DEFAULT '0',
  `acak` varchar(2) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `opsi` varchar(10) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `kelas` varchar(10) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `nilai` varchar(3) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL
...
(5, 'PTS', 'PJOK', 'TKJ-PJOK', '15', '00:15:00', '', 0, '1', 'show', '10', ''),
(4, 'PTS', 'Pemrograman Dasar', 'Pogdas-UTS', '60', '01:00:00', 'BC', 1, '1', 'show', '10', '5');
...
(3, 'admin', 'Administrator', 'admin utama', 'admin12345', 1, 1, NULL, 'https://www.instagram.com/websitesekolah/', '', '0872627181811', '1'),
...
--
ALTER TABLE `ujian`
  MODIFY `Urut` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
